...
//
//        Runner(PasswordEncoder passwordEncoder, UserService userService, RoleService roleService, BookService bookService, ReviewService reviewService, RateService rateService, OrderService orderService, OrderItemService orderItemService) {
...
//////            User user = new User("thienvuvan","0382848684","thienvuvan2003@gmail.com","123456789");
//////            user.setPassword(passwordEncoder.encode(user.getPassword()));
//////            userRepository.save(user);
//////            Role role = new Role("ROLE_ADMIN");
//////            roleRepository.save(role);
////            User user = userService.retrieveByUserName("thienvuvan");
////            Role role = roleService.retrieveByName("ROLE_ADMIN");
////            user.addRole(role);
